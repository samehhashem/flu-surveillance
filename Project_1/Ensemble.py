...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 18:40:14 2017
...
dense_train_dif = train_features_dif.toarray()
...
dense_train_all = train_features_all.toarray()
test_features_all=v_dif.transform(test_clean_tweet)
dense_test_all =test_features_all.toarray()



clf1 = GaussianNB()
clf1.fit(dense_train_all,train['label'])
clf2 = MLPClassifier(hidden_layer_sizes=(20,20,20,20),max_iter=400)
clf2.fit(dense_train_all,train['label'])
clf3 = AdaBoostClassifier()
clf3.fit(dense_train_all,train['label'])

eclf = VotingClassifier(estimators=[('GNB', clf1), ('MLP', clf2), ('ABC', clf3)],\
                                    voting='soft')
eclf.fit(dense_train_all,train['label'])
